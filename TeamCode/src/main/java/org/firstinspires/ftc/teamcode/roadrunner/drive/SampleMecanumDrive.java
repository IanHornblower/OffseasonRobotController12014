...
public class SampleMecanumDrive extends MecanumDrive {
    Servo leftRetraction, rightRetraction, perpRetraction;

    static double leftRet = 0, leftReleax = 1;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftRetraction = hardwareMap.get(Servo.class, "leftRe");
        rightRetraction = hardwareMap.get(Servo.class, "rightRe");
        perpRetraction = hardwareMap.get(Servo.class, "latRe");
    ...
    public void retract() {
        leftRetraction.setPosition(leftRet);
        rightRetraction.setPosition(rightRet);
        perpRetraction.setPosition(perpRet);
    }
